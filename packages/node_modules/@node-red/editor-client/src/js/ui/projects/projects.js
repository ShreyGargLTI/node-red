            ...
            'welcome': {
                content: function(options) {
                   ...
                   var row = $('<div style="text-align: center"></div>').appendTo(body);
                    ...
                    /* $('<button style="width: 120px;" class="red-ui-button">'+RED._("projects.clone-project.ssh-key-add")+'</button>').appendTo(subrow).on("click", function(e) {
                        e.preventDefault();
                        dialog.dialog( "close" );
                        RED.userSettings.show('gitconfig');
                        setTimeout(function() {
                   ...
                   var createAsEmpty = $('<button style="display:none;" data-type="empty" class="red-ui-button red-ui-projects-dialog-screen-create-type"><i class="fa fa-archive fa-2x"></i><i style="position: absolute;display:none;" class="fa fa-asterisk"></i><br/>'+RED._("projects.welcome.create")+'</button>').appendTo(row);
                    
                   var createAsClone = $('<button style="display:none" data-type="clone" class="red-ui-button red-ui-projects-dialog-screen-create-type"><i class="fa fa-archive fa-2x"></i><i style="position: absolute;" class="fa fa-git"></i><br/>Clonning Repository</button>').appendTo(row);
                   
                   subrow = $('<div style="width: calc(50% - 10px); margin-left: 20px; display:inline-block;"></div>').appendTo(row);
                   $('<label for="red-ui-projects-dialog-screen-create-project-repo-pass"> GitHub Password </label>').appendTo(subrow);
                   ...
                   var createAsCloneProject = $('<button data-type="clone" class="red-ui-button red-ui-projects-dialog-screen-create-type"><i class="fa fa-archive fa-2x"></i><i style="position: absolute;" class="fa fa-git"></i><br/>Clone Task</button>').appendTo(row);
                    ...
                    createAsCloneProject.on("click", function(e) {
                        e.preventDefault();
                        createProjectOptions = {
                            action: "clone"
                        }
                       ...
                       // show('git-config');
                        ...
                        //get task details
                        var userId = sessionStorage.getItem("gituserId");
                        var email = sessionStorage.getItem("gituserEmail");
                        var projectname = sessionStorage.getItem("projectName");
                        var remoteurl = sessionStorage.getItem("gitremoteUrl");
                    
                       var gitpassword = "";
                       if(projectRepoPasswordInput.val() != null){
                        gitpassword = projectRepoPasswordInput.val();
                       }
                      // console.log("projectRepoPasswordInput.val()"+projectRepoPasswordInput.val());
                      // console.log( "userName",  sessionStorage.getItem("gituserId"), "remoteurl", sessionStorage.getItem("gitremoteUrl"));
                       var gitData={
                       userName:  userId,
                       ...
                       currentGitSettings.user.name = gitData.userName;
                       currentGitSettings.user.email = gitData.emailId;
                    ...
                    projectData.credentialSecret = null;
                    projectData.git = {
                        remotes: {
                            'origin': {
                                url: gitData.remoteurl,
                                username: gitData.userName,
                                password: gitData.password
                    ...
                    sendRequest({
                        ...
                        responses: {
                            200: function(data) {
                                ...
                                //sessionStorage.setItem("cloneProjectDone");
                                dialog.dialog( "close" );
                            },
                            400: {
            ...
            'git-config': (function() {
                ...
                return {
                    content: function(options) {
                       ...
                       // sessionStorage.setItem("gitItem","gitNameTest");
